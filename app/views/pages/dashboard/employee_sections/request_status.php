...
<body class="bg-gradient-light fondopag">
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav justify-content-center flex-grow-1 pe-3">
                        ...
                        <li class="nav-item">
                            <a class="nav-link mx-lg-2 active" href="<?php echo RUTA_URL; ?>/EmployeeController/requestStatus">Estado de solicitud</a>
                        </li>
                        <li class="nav-item">
    ...
    <div class="row vh-100 g-0">
        ...
        <div class="col-lg-6 position-relative d-none d-lg-block">
            <div class="bg-holder-reqsta"></div>
        </div>
                ...
                <div class="col col-sm-6 col-lg-7 col-xl-9">
                    <div class="form-container">
                        <div class="text-center mb-5 mt-5">
                            <h1 class="fw-bold">Verifica Tus Vacaciones</h1>
                        </div>
                        ...
                        <?php else : ?>
                            ...
                            <?php else : ?>
                                <div class="alert alert-success" role="alert">No tienes solicitudes de vacaciones registradas.</div>
                            <?php endif; ?>
                        <?php endif; ?>
