<?php
    ...
    $email="agustin.santillan.unlz@gmail.com";
    $pass ="jpku cvia mcli lyae";
    $from_name ="GESTION RECURSOS HUMANOS";
    $host = "smtp.gmail.com";
    $port = 465;
    $smtp_auth=true;
    $smtp_secure=  'ssl';
    ...
    $body = "<p>Hola
            <br>
            Tu nueva contraseña para utilizar el gestor de recursos humanos es:<br> <b>{$new_pass}</b><br>
            Podrás cambiar esta contraseña ingresando al siguiente
            
            <a href={$link}>Link</a><br>
            Saludos,<br>
            El equipo de <b>UNLZ</b>
            </p>";
    $mail = new PHPMailer();
    try{
